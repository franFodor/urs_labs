A little project made for the development board at FER with ATmega4809 microcontroller. Contains functions for initializing various peripherals in `utils.c` file.
